...
//var TabBarExample = require('./Components/TabBarExample.js');
...
class AwesomeProject extends Component {
   ...
   _renderContent(color: string, pageText: string, num?: number) {
    return (
      <View style={[stylesTab.tabContent, {backgroundColor: color}]}>
        <Text style={stylesTab.tabText}>{pageText}</Text>
        <Text style={stylesTab.tabText}>{num} re-renders of the {pageText}</Text>
      </View>
    );
  }
  ...
  render : function() {
    ...
    return (
      <View style={myStyle.container2}>
        <Text style={myStyle.welcome}>
          Welcome to React Native!
        </Text>
        <Text style={myStyle.instructions}>
        ...
        <Text style={myStyle.instructions}>
          Shake or press menu button for dev menu {this.props.counter}
        </Text>
      </View>
    );
  },
